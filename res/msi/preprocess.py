...
g_arpsystemcomponent = {
    ...
    "Contact": {
        "msi": "ARPCONTACT",
        "v": "https://github.com/SelfDesk/SelfDesk",
    },
    "HelpLink": {
        "msi": "ARPHELPLINK",
        "v": "https://github.com/SelfDesk/SelfDesk/issues/",
    },
    "ReadMe": {
        "msi": "ARPREADME",
        "v": "https://github.com/SelfDesk/SelfDesk",
...
def update_license_file(app_name):
    ...
    license_content = re.sub("SelfDesk Ltd", app_name, license_content, flags=re.IGNORECASE)
